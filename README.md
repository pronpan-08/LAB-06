...
2). โปรแกรมสำหรับรับตัวอักษรจากคีย์บอร์ด 
 ...
 ![](https://github.com/Desktop-Programming-Lab-2559/LAB-06/blob/master/imgs/pic1.png)
  ...
  เมื่อทำการกดรันโปรแกรมแล้ว จะปรากฎ หน้า command line 
  
  จากนั้นเมื่อพิมพ์ตัวอักษรไปหนึ่งตัวอักษรและกด enter จะปรากฎข้อความเพิ่มเติมตามรูปที่2

  ![](https://github.com/pronpan-08/LAB-06/blob/master/imgs/lab6-1.png?raw=true)
<hr>
<hr>
<hr>
<hr>
...
ตอบ  เมื่อพิมพ์ตัวอักษรหลายๆตัวแล้วกด Enter จะปรากฎตัวอักษรแค่ตัวแรกตัวเดียว  เพราะ char เก็บเป็นตัวอักษร ไม่ได้เก็บเป็นข้อความ
<hr>
<hr>
<hr>
<hr>
...
![](https://github.com/pronpan-08/LAB-06/blob/master/imgs/lab6-2%E0%B8%81%E0%B9%88%E0%B8%AD%E0%B8%99.png?raw=true)
<hr>
<hr>
<hr>
<hr>
...
3).	โปรแกรมสำหรับรับ string จากคีย์บอร์ด
 ...
 ตอบจะขึ้นข้อความที่เราพิมพ์ ดังปรากฎดังรูป
 
 ![](https://github.com/pronpan-08/LAB-06/blob/master/imgs/lab6-3.png?raw=true)
<hr>
<hr>
<hr>
<hr>
...
![](https://github.com/pronpan-08/LAB-06/blob/master/imgs/lab6-4.2.png?raw=true)
<hr>
<hr>
<hr>
<hr>
...
ตอบ  เมื่อเป็นตัวหนังสือจะเออเร้อ เพราะชนิดข้อมูไม่ตรงกัน
มีวิธีป้องกันโดยการ เขียนกำกับไว้ว่าให้ใส่ตัวเลข
...
5).	โปรแกรมสำหรับรับค่าตัวเลข แต่ในบางกรณีที่ผู้ใช้ป้อนตัวอักษร จะทำให้เกิด error และทำให้โปรแกรม hang ได้ จึงต้องมีการป้องกันโดยใช้ประโยค ```try{…} catch{…}```  (ประโยค ```try{…} catch{…}``` นี้จะศึกษารายละเอียดภายหลัง)
  ...
  เมื่อทำการรันโปรแกรม และใส่ตัวเลข ครั้งที่หนึ่งและครั้งที่สอง และกดเอนเทอร์อีกครั้ง จะได่เป็นคำตอบโดยเอาทั้งสองบวกกันดังรูป
  
  ![](https://github.com/pronpan-08/LAB-06/blob/master/imgs/lab6-5.2.png?raw=true)
<hr>
<hr>
<hr>
<hr>
...
ตอบ โปรแกรมจะขึ้นเตือนเมื่อเป็นตัวหนังสือจะเออเร้อ เพราะชนิดข้อมูไม่ตรงกัน

![](https://github.com/pronpan-08/LAB-06/blob/master/imgs/lab6%E0%B9%81%E0%B8%9A%E0%B8%9A%E0%B8%9D%E0%B8%B6%E0%B8%81%E0%B8%AB%E0%B8%B1%E0%B8%94.png?raw=true)
<hr>
<hr>
<hr>
<hr>
